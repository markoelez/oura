...
from .auth import get_access_token, load_env, refresh_access_token
...
class OuraClient:
    ...
    def _request(self, method: str, path: str, **kwargs) -> dict:
        ...
        if response.status_code == 401:
            ...
            response = httpx.request(
                method, url, headers=self._bearer_headers(), **kwargs
            )
    ...
    def get_document(self, data_type: str, document_id: str) -> dict:
        return self._request(
            "GET", f"/v2/usercollection/{data_type}/{document_id}"
        )
