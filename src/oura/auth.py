...
def load_env() -> tuple[str, str]:
  ...
  if not client_id or not client_secret:
    raise RuntimeError("CLIENT_ID and CLIENT_SECRET must be set in environment or .env file")
  return client_id, client_secret
  ...
  class CallbackHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
      ...
      if "code" in params:
        ...
        self.end_headers()
        self.wfile.write(b"<h1>Authorized!</h1><p>You can close this window.</p>")
      else:
